...
.LinkList .widget-control ul li a:hover,.PageList .widget-control ul li a:hover{color:$(main.hover);transition:all .5s ease;border-radius:4px}
...
body#layout:before{content:"Galaxy";font-family:MONOSPACE;position:absolute;top:20px;right:20px;z-index:1;padding:6px 14px;font-size:15px;border-radius:10px;font-weight:400;color:#919191;background:#fdfdfd;border:1px solid #cac9c9 !important;}
...
<b:defaultmarkups>
  ...
  <b:if cond='data:widget.sectionId not in [&quot;ft-post&quot;, &quot;main-ads-below&quot;]'>
    ...
    <b:section class='admin-section' id='admin' maxwidgets='1' name='Theme Options (Admin Panel)' showaddelement='no'>
      ...
      <b:widget id='LinkList25' locked='true' title='Variables / Comments' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          ...
          <b:widget-setting name='text-1'>noThumb</b:widget-setting>
          <b:widget-setting name='link-1'>//3.bp.blogspot.com/-Yw8BIuvwoSQ/VsjkCIMoltI/AAAAAAAAC4c/s55PW6xEKn0/s1600-r/nth.png</b:widget-setting>
          <b:widget-setting name='text-0'>commentsSystem</b:widget-setting>
          <b:widget-setting name='link-0'>blogger</b:widget-setting>
        </b:widget-settings>
        <b:includable id='main'>
          <b:include name='content'/>
        </b:includable>
            ...
            <div class='row'>
              <div id='top-menu'>
                <b:section class='menu-top' id='menu-top' maxwidgets='1' name='Top Menu' showaddelement='no'>
                  <b:widget id='LinkList3' locked='true' title='Top menu' type='LinkList' version='2' visible='false'>
                    <b:widget-settings>
                      <b:widget-setting name='link-3'>/https://khabarbhawan.blogspot.com/p/disclaimer.html</b:widget-setting>
                      <b:widget-setting name='sorting'>NONE</b:widget-setting>
                      <b:widget-setting name='text-1'><![CDATA[Terms & conditions ]]></b:widget-setting>
                      <b:widget-setting name='link-1'>https://khabarbhawan.blogspot.com/p/terms-condition.html</b:widget-setting>
                      <b:widget-setting name='text-0'>About Us</b:widget-setting>
                      <b:widget-setting name='link-2'>https://khabarbhawan.blogspot.com/p/privacy-policy.html</b:widget-setting>
                      <b:widget-setting name='text-3'>Disclaimer </b:widget-setting>
                      <b:widget-setting name='link-0'>https://khabarbhawan.blogspot.com/p/about-us.html</b:widget-setting>
                ...
                <b:section class='social-sec' id='social-sec' maxwidgets='1' name='Top Social icons' showaddelement='no'>
                  <b:widget id='LinkList4' locked='true' title='top social' type='LinkList' version='2' visible='true'>
                    <b:widget-settings>
                      ...
                      <b:widget-setting name='link-0'>Facebook.khabarbhawan.com</b:widget-setting>
        ...
        <div class='container'>
          ...
          <div class='header-section'>
            ...
            <b:section class='SuperLogo' id='SuperLogo' maxwidgets='1' name='Main Logo' showaddelement='no'>
              <b:widget id='Header1' locked='true' title='Khabar Bhawan (Header)' type='Header' version='2' visible='true'>
                <b:widget-settings>
      ...
      <b:if cond='data:view.search.label'><h2 class='blog-title'><b:tag expr:href='data:blog.homepageUrl' name='a'><data:view.search.label/></b:tag></h2></b:if>
            ...
            <b:section class='xx0xx-promenu' id='xx0xx-promenu' maxwidgets='1' name='Main Menu' showaddelement='no'>
              <b:widget id='LinkList56' locked='true' title='Main Menu' type='LinkList' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='text-10'>Mobile phone </b:widget-setting>
                  <b:widget-setting name='sorting'>NONE</b:widget-setting>
                  <b:widget-setting name='link-1'>menue/recent</b:widget-setting>
                  <b:widget-setting name='link-2'>#</b:widget-setting>
                  <b:widget-setting name='link-12'>https://https://khabarbhawan.blogspot.com/p/stock-market.html</b:widget-setting>
                  <b:widget-setting name='link-0'>/</b:widget-setting>
                  <b:widget-setting name='link-11'>https://https://khabarbhawan.blogspot.com/p/hindi-news.html</b:widget-setting>
                  <b:widget-setting name='link-10'>https://khabarbhawan.blogspot.com/p/mobile-phones.html</b:widget-setting>
                  ...
                  <b:widget-setting name='text-11'>Hindi news </b:widget-setting>
                  <b:widget-setting name='text-12'>Stock market </b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
                  <b:include name='content'/>
                </b:includable>
...
<div class='container'>
  <b:section class='GalaxyPSpeedTic' id='hot-posts' maxwidgets='1' name='Breaking Ticker' showaddelement='yes'>
	...
	atOptions = {
		'key' : '08d1475ccd2b5f32213cde92f30f6fd1',
		'format' : 'iframe',
		'height' : 90,
		'width' : 728,
		'params' : {}
...
<script type="text/javascript" src="//www.topcreativeformat.com/08d1475ccd2b5f32213cde92f30f6fd1/invoke.js"></script>]]></b:widget-setting>
                   </b:widget-settings>
                   <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    ...
    <div class='container outer-container'>
      ...
      <b:if cond='data:view.isHomepage'>
       <b:section class='GalaxyPSpeedPro' id='top-NewsPro-main-widget-2' maxwidgets='1' name='Fresh Posts Section' showaddelement='no'>
         <b:widget id='HTML42' locked='false' title='Top Stories' type='HTML' visible='true'>
           <b:widget-settings>
  ...
  <div class='widget-content'>
    <data:content/>
         ...
         <b:widget id='HTML43' locked='false' title='What&apos;s New' type='HTML' visible='true'>
           <b:widget-settings>
  ...
  <b:loop values='data:regionItems' var='byline'>
    <b:include data='byline' name='bylineByName'/>
            ...
            <b:includable id='commentFormIframeSrc' var='post'>
              <a expr:href='data:post.commentFormIframeSrc + &quot;&amp;skin=contempo&quot;' id='comment-editor-src' rel='nofollow noopener' title='Comment Form Link'/>
            </b:includable>
                ...
                <li class='post-next'>
                  <b:if cond='data:newerPageUrl'>
                    <a class='next-post-link' expr:href='data:newerPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-newer-link&quot;' rel='next'>
                      <div class='xx0o-postnav-inner'><span><data:messages.newer/></span><p/></div>
                    </a>
                    <b:else/>
                    <a rel='next'><div class='xx0o-postnav-inner post-xxqo-menuaflex-open'><span><data:messages.newer/></span><p><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></p></div></a>
                  </b:if>
                </li>
                <li class='post-prev'>
                  <b:if cond='data:olderPageUrl'>
                    <a class='prev-post-link' expr:href='data:olderPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-older-link&quot;' rel='previous'>
                      <div class='xx0o-postnav-inner'><span><data:messages.older/></span><p/></div>
                    </a>
                    <b:else/>
                    <a rel='previous'><div class='xx0o-postnav-inner post-xxqo-menuaflex-open'><span><data:messages.older/></span><p><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></p></div></a>
                  </b:if>
                </li>
              </ul>
            </b:includable>
  ...
  <div class='blog-pager container' id='blog-pager'>
    ...
    <b:include cond='data:view.url != data:blog.homepageUrl' name='homePageLink'/>
          ...
          <b:section cond='data:view.isPost' id='upper-ad' maxwidgets='1' name='Show Top Ad' showaddelement='no'>
            <b:widget id='HTML8' locked='true' title='Top Post Ad' type='HTML' version='2' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'><![CDATA[script type="text/javascript">
	atOptions = {
		'key' : '85bcae2d799d1e6b423b0bff24c403fe',
		'format' : 'iframe',
		'height' : 50,
		'width' : 320,
		'params' : {}
...
<script type="text/javascript" src="//www.topcreativeformat.com/85bcae2d799d1e6b423b0bff24c403fe/invoke.js"></script>]]></b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:section cond='data:view.isPost' id='lower-ad' maxwidgets='1' name='Show Bottom Ad' showaddelement='no'>
            <b:widget id='HTML9' locked='true' title='Bottom Post Ad' type='HTML' version='2' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'><![CDATA[<script async="async" data-cfasync="false" src="//pl24363653.cpmrevenuegate.com/d023ef6e74b22d910e7d3d87af84d502/invoke.js"></script>
<div id="container-d023ef6e74b22d910e7d3d87af84d502"></div>]]></b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <div class='widget-content'>
    <data:content/>
        ...
        <b:section class='main-ads-pikihome' id='main-ads-below' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
          <b:widget id='HTML7' locked='true' title='Ads section' type='HTML' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<script type="text/javascript">
	atOptions = {
		'key' : '410d0b943e438f555237fdd4386032df',
		'format' : 'iframe',
		'height' : 60,
		'width' : 468,
		'params' : {}
...
<script type="text/javascript" src="//www.topcreativeformat.com/410d0b943e438f555237fdd4386032df/invoke.js"></script>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
              <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
      ...
      <div id='sidebar-container' itemscope='itemscope' itemtype='https://schema.org/WPSideBar' role='banner'>
        <b:section class='sidebar' id='sidebar' name='Sidebar Right' showaddelement='yes'>
          <b:widget id='LinkList76' locked='true' title='Social Plugin' type='LinkList' version='2' visible='false'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    ...
    <b:if cond='data:copyright != &quot;&quot;'>
      <div class='copyright'><data:copyright/></div>
          ...
          <b:widget id='LinkList1' locked='false' title='Menu' type='LinkList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='text-1'>about</b:widget-setting>
              <b:widget-setting name='link-1'>https://https://trendingtopicyt.blogspot.com/p/about-us.html</b:widget-setting>
              <b:widget-setting name='text-0'>home</b:widget-setting>
              <b:widget-setting name='link-0'>http://https://trendingtopicyt.blogspot.com/</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
          ...
          <b:widget id='LinkList2' locked='false' title='Social Media Icons' type='LinkList' visible='false'>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
 ...
 <div class='widget-content widget-control'>
  ...
  <b:include name='reportAbuse'/>
          ...
          <b:widget id='Profile1' locked='false' title='&quot;I delivers the latest updates on trending and viral YouTube videos, keeping you always informed &quot;' type='Profile' visible='true'>
            <b:widget-settings>
    ...
    <data:messages.viewMyCompleteProfile/>
      ...
      <div class='post'>
        <div class='post-content'>
          ...
          <b:widget id='Subscribe1' locked='false' title='' type='Subscribe' visible='false'>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
    ...
    <span class='label-size'>
      ...
      <ul>
        <b:loop values='data:labels' var='label'>
          ...
          <b:widget id='HTML10' locked='false' title='Home PageNav Display' type='HTML' version='1'>
            <b:widget-settings>
          ...
          <b:widget id='HTML11' locked='false' title='Related Posts Display' type='HTML' version='1'>
            <b:widget-settings>
              <b:widget-setting name='content'/>
            </b:widget-settings>
            <b:includable id='main'>
          ...
          <b:widget id='HTML12' locked='false' title='Item Post Navigation Display' type='HTML' version='1'>
            <b:widget-settings>
              <b:widget-setting name='content'/>
            </b:widget-settings>
            <b:includable id='main'>
  ...
  <script src='//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit'/>
          ...
          <b:widget id='HTML16' locked='false' title='Tennis' type='HTML' visible='false'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML17' locked='false' title='Racing' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<span data-label="Racing" id="box"></span>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='PageList1' locked='false' title='' type='PageList' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"6954564342875732098":{"href":"https://khabarbhawan.blogspot.com/p/about-us.html","position":0,"title":"About us"},"6647479606747539512":{"href":"https://khabarbhawan.blogspot.com/p/disclaimer.html","position":2,"title":"Disclaimer "},"link0":{"href":"https://trendingtopicyt.blogspot.com/p/terms-condition.html","position":3,"title":"Terms & condition "},"2663617958202099993":{"href":"https://khabarbhawan.blogspot.com/p/privacy-policy.html","position":1,"title":"Privacy policy "}}]]></b:widget-setting>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
          ...
          <b:widget id='HTML4' locked='false' title='Random Posts' type='HTML' visible='false'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML3' locked='false' title='Follow Us' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<div class="social-count-plus"><ul class="flat"><li class="count-twitter"><a class="icon" href="https://twitter.com/"></a><span class="items"><span class="count" style="color: #ffffff !important;">12356</span><span class="label" style="color: #ffffff !important;">followers</span></span></li><li class="count-facebook"><a class="icon" href="https://www.facebook.com/"></a><span class="items"><span class="count" style="color: #ffffff !important;">194067</span><span class="label" style="color: #ffffff !important;">likes</span></span></li><li class="count-googleplus"><a class="icon" href="https://plus.google.com/"></a><span class="items"><span class="count" style="color: #ffffff !important;">419</span><span class="label" style="color: #ffffff !important;">followers</span></span></li></ul></div>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML6' locked='false' title='Sponsor' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<img src="https://4.bp.blogspot.com/-ehCdxQEWqQ8/WQ2JCmfT43I/AAAAAAAAJz0/79he5FvgGnECpfXnb6gHkIoy3K9-kFSBwCLcB/s1600/sidebar-ad.jpg"/>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML5' locked='false' title='Facebook' type='HTML' version='1'>
            <b:widget-settings>
              <b:widget-setting name='content'/>
            </b:widget-settings>
            <b:includable id='main'>
          ...
          <b:widget id='PopularPosts2' locked='false' title='Popular Posts' type='PopularPosts' visible='false'>
            <b:widget-settings>
  ...
  <div class='container outer-container'>
  <b:section class='GalaxyPSpeedPro' id='footer-flex' maxwidgets='1' name='Footer Video Section' showaddelement='no'>
    <b:widget id='HTML13' locked='true' title='Top Videos' type='HTML' version='2' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='content'>megagrid/recent</b:widget-setting>
      </b:widget-settings>
      <b:includable id='main'>
 ...
 <div id='footer-ads'>
  <div class='container outer-container'>
    <!-- Center Featured Posts -->
      <b:section class='GalaxyPSpeedPro' id='footer-flex-ok' maxwidgets='3' name='Footer Trending Posts' showaddelement='no'>
        <b:widget id='HTML18' locked='true' title='Trending Weekly' type='HTML' visible='true'>
          <b:widget-settings>
...
<script type="text/javascript" src="//www.topcreativeformat.com/85bcae2d799d1e6b423b0bff24c403fe/invoke.js"></script>]]></b:widget-setting>
  ...
  <div class='widget-content'>
    ...
    <b:widget id='HTML20' locked='false' title='Ads' type='HTML' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='content'><![CDATA[<script type='text/javascript' src='//pl24355260.cpmrevenuegate.com/47/f7/b0/47f7b0c2ba4cbf201155adccf7e89a4c.js'></script>]]></b:widget-setting>
      </b:widget-settings>
      <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
...
<div id='footer-wrapper' itemscope='itemscope' itemtype='https://schema.org/WPFooter' role='banner'>
  <div class='container outer-container'>
      <b:section class='GalaxyFooter' id='GalaxyFooter' maxwidgets='2' name='Footer Info' showaddelement='yes'>
        <b:widget id='Image150' locked='true' title='About Us' type='Image' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEhDz-0GhcMJWBVf-Hlv7FT9FlCfTzksoGPMLd98yhtGOCbn0qftRqNm8KmPO19pec01xExT4-hotnqyyFsmJLauo6Q-UWK_uZlm7Jt5Ht52tYo4XZLkuKz2MxRn4l_kt7jbpYErsiqQZaNWFT_n72A9x4NxyC-i6YkDW_OZ2yFXNJC-BgNb47NCt7EvZPtG=s1600</b:widget-setting>
            <b:widget-setting name='displayHeight'>1368</b:widget-setting>
            <b:widget-setting name='sectionWidth'>150</b:widget-setting>
            <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
            <b:widget-setting name='displayWidth'>1600</b:widget-setting>
            <b:widget-setting name='link'>https://khabarbhawan.blogspot.com/p/about-us.html</b:widget-setting>
            <b:widget-setting name='caption'><![CDATA[This website providing you trending topic news and tatest government yojana update & technology update]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
        ...
        <b:widget id='LinkList7' locked='true' title='Follow Us' type='LinkList' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='link-3'>/https://khabarbhawan.blogspot.com/p/about-us.html</b:widget-setting>
            <b:widget-setting name='sorting'>NONE</b:widget-setting>
            <b:widget-setting name='link-4'>/https://khabarbhawan.blogspot.com/p/about-us.html</b:widget-setting>
            <b:widget-setting name='text-1'>twitter</b:widget-setting>
            <b:widget-setting name='link-1'>/https://khabarbhawan.blogspot.com/p/about-us.html</b:widget-setting>
            <b:widget-setting name='text-0'>facebook-f</b:widget-setting>
            <b:widget-setting name='link-2'>/https://khabarbhawan.blogspot.com/p/about-us.html</b:widget-setting>
   ...
   <div id='footer-container'>
        <b:section class='footer-checks-menu' id='footer-checks-menu' maxwidgets='1' name='Footer Menu' showaddelement='yes'>
      ...
      <b:section class='footer-copyright' id='footer-copyright' maxwidgets='1' name='Footer Attribution' showaddelement='no'>
        <b:widget id='HTML33' locked='true' title='Footer Copyright' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<span class='copyright-text widget'>Design by - Free update regarding to trending topic and yojana & scheme </span>]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
